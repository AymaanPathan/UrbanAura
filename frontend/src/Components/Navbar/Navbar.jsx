...
function Navbar() {
  ...
  return (
    <div className='main border-b py-4 justify-between items-center md:flex nav-container'>
      ...
      <div className={`md:flex md:items-center ${menuOpen ? 'flex-col text-center ' : 'hidden'}`}>
        <ul className='md:flex md:gap-6 md:items-center md:font-medium md:flex-row'>
          {token && (
            <li className='text-gray-500 cursor-pointer font-light hover:text-black' onClick={closeMenu}>
              Welcome, {name}
            </li>
          )}
